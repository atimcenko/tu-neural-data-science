...
example_file = '../data/prac2_dff.npy'
frame_rate = 30.1458 # in Hz
...
model_name = 'Global_EXC_30Hz_smoothing50ms_asymmetric_window_4_frames'
...
save_path = os.path.join(folder, f"spikes_{model_name}.npy")
